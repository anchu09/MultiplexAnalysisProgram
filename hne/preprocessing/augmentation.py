...
def augment_patch(
    ...
    Args:
        rgb: uint8 (H, W, 3) RGB patch.
        hema: uint8 (H, W) hematoxylin channel.
        eosin: uint8 (H, W) eosin channel.
        mask: uint8 (H, W) segmentation mask.
        n_augments: Number of augmented copies to produce.
        seed: Optional random seed for reproducibility.

    Returns:
        List of (rgb, hema, eosin, mask) tuples with the same dtypes and shapes.
    """
    if seed is not None:
        random.seed(seed)
